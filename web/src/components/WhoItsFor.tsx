...
const PERSONAS = [
  ...
  },
  {
    ...
    description: "67 computational tools, 15 external APIs, structured reporting. Commercial license for private modifications. Self-hosted deployment available.",
  },
] as const;

    ...
    switch (eventType) {
      case "hypothesis_formulated": {
        const h: Hypothesis = {
          ...
          prediction: (parsed.data.prediction as string) || "",
          null_prediction: (parsed.data.null_prediction as string) || "",
          success_criteria: (parsed.data.success_criteria as string) || "",
          failure_criteria: (parsed.data.failure_criteria as string) || "",
          scope: (parsed.data.scope as string) || "",
          hypothesis_type: (parsed.data.hypothesis_type as string) || "",
          prior_confidence: (parsed.data.prior_confidence as number) || 0,
          status: "proposed",

...
See `README.md` for setup, tools catalog (85 tools), data sources (18 APIs), API endpoints, and demo instructions.
...
Sonnet 4.5 (Researcher) -- Executes experiments with 85 tools (parallel: 2 experiments per batch)
...
| impact | `server/src/ehrlich/impact/` | Economic indicators (World Bank, WHO GHO, FRED), cross-program comparison, benchmarking |

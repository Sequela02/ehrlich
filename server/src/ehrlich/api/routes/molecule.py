...
async def conformer(smiles: str = Query(..., description="SMILES string")) -> dict[str, Any]:
    try:
...
async def descriptors(smiles: str = Query(..., description="SMILES string")) -> dict[str, Any]:
    try:

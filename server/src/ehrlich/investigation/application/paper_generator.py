...
def generate_paper(
    ...
    sections["supplementary"] = _build_supplementary(
        cost_data, negative_controls, positive_controls, validation,
    )
...
def _build_title(
    prompt: str, domain: str, created_at: str, investigation_id: str,
) -> str:
    ...
    lines = [
        ...
        f"_Domain: {domain or 'auto-detected'} | Date: {date} | "
        f"ID: {investigation_id}_",
    ]
    return "\n".join(lines)

...
6 tools that enable evidence-based training science research:
literature search, training evidence analysis, protocol comparison,
injury risk assessment, training metrics computation, and clinical
trial search.
"""
...
_service = TrainingService(paper_repo=_client, clinical_trials=_ct_client)

"""Tests for the DiD estimator (moved from impact/)."""
...
class TestDiDEstimator:
    def test_known_effect(self, estimator: DiDEstimator) -> None:
        ...
        result = estimator.estimate(treatment_pre, treatment_post, control_pre, control_post)
    ...
    def test_no_effect(self, estimator: DiDEstimator) -> None:
        ...
        treatment_post = [52.0, 53.0, 51.5, 52.5]
        control_pre = [50.0, 51.0, 49.5, 50.5]
        control_post = [52.0, 53.0, 51.5, 52.5]
    ...
    def test_large_effect(self, estimator: DiDEstimator) -> None:
        ...
        treatment_post = [30.0, 31.0, 30.5]
        control_pre = [10.0, 11.0, 10.5]
        control_post = [11.0, 12.0, 11.5]
    ...
    def test_small_sample_threat(self, estimator: DiDEstimator) -> None:
        result = estimator.estimate([10.0, 11.0], [15.0, 16.0], [10.0, 11.0], [11.0, 12.0])
        threat_types = [t.type for t in result.threats]
    ...
    def test_evidence_tier(self, estimator: DiDEstimator) -> None:
    ...
    def test_single_values(self, estimator: DiDEstimator) -> None:
        result = estimator.estimate([10.0], [15.0], [10.0], [11.0])
